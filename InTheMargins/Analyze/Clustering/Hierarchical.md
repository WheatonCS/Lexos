...
1. __Tool Tip:__  
   none
2. __Tool Tip Extended:__  
   * Vertical: displays the dendrogram vertically with the filenames (leafs) at the bottom.  
   * Horizontal: displays the dendrogram horizontally with the filenames (leafs) to the right.  
3. __Example:__  
