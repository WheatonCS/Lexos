$(function () {
  ...
  /*when you hover around open folder icon on the right top corner*/
          ...
          success: function (res) {
            ...
            reader.onload = function (e) {
              ...
              if (file.type === '') {
                ...
                let contents = e.target.result.replace(/</g, '&lt;')
                  .replace(/>/g, '&gt;')
              }
...
function AllowedFileType(filename) {
  ...
  /*search the extension of the file uploaded to the list 'allowedFileTypes'
    and returns -1 if it can't be found*/
