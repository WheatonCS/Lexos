class Table{
     ...
     * @param {string} csv: The CSV data to send when the "Download" button is
     *      clicked.
     */
    static create_basic_table(parent_element_query,
        data, head = [], title = '', csv = '') {
     ...
     * @param {string} request_url: The URL to send the request for table data
     *      to.
     * @param {string} parent_element_query: The query for the table's parent
     *      element.
     ...
     * @param {boolean} generate_button: Whether to give the table a generate
     *      button.
     * @param {boolean} download_button: Whether to give the table a download
     *      button.
    ...
    create(){
        ...
        send_ajax_form_request(this.request_url)
            ...
            .done(function(response){
                ...
                // text
                else add_text_overlay(`#${table.name}-table-content`,
                        "No Results");
            })
    ...
    /**
     * Applies the highlight to the selected cell and calls the cell selection
     *      callback.
     * @private
     */
