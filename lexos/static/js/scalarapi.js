...
function ScalarAPI() {
  ...
  this.mediaSources = {
    ...
    this.loadCurrentPageStatus = {
        isLoading: false,
        queuedSuccessCallbacks: [],
        queuedErrorCallbacks: []
    }
    this.loadBookStatus = {
        isLoading: false,
        queuedSuccessCallbacks: [],
...
function ScalarModel (options) {
    ...
    this.nodePropertyMap = [
        ...
        {
            property: 'color',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#color',
            type: 'string'
        },
        {
            property: 'title',
        ...
        {
            property: 'thumbnail',
            uri: 'http://simile.mit.edu/2003/10/ontologies/artstor#thumbnail',
            type: 'string'
        },
        {
        ...
        {
            property: 'urn',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#urn',
            type: 'string'
        },
        {
            property: 'background',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#background',
            type: 'string'
        },
        {
            property: 'audio',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#audio',
            type: 'string'
        },
        {
            property: 'isLive',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#isLive',
            type: 'int'
        },  // Add by Craig 21 July 2014
        {
            property: 'paywall',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#paywall',
            type: 'string'
        },  // Add by Craig 15 August 2014
        {
            property: 'author',
    ...
    this.versionPropertyMap = [
        {
            property: 'number',
            uri: 'http://open.vocab.org/terms/versionnumber',
            type: 'int'
        },
        {
            property: 'created',
        ...
        },
        {
            ...
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#defaultView',
            type: 'string'
        },
        {
            property: 'baseType',
        ...
        {
            property: 'sourceFile',
            uri: 'http://simile.mit.edu/2003/10/ontologies/artstor#url',
            type: 'string'
        },
        {
            property: 'creator',
        ...
        {property: 'thumbnail', uri: 'artstor:thumbnail', type: 'string'},
        {
            ...
            uri: 'http://simile.mit.edu/2003/10/ontologies/artstor#sourceLocation',
            type: 'string'
        },
        {
            property: 'urn',
        ...
        {
            property: 'sortNumber',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#sort_number',
            type: 'int'
        },
        {
            property: 'continueTo',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#continue_to',
            type: 'int'
        },
        {
            property: 'continueToContentId',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#continue_to_content_id',
            type: 'int'
        },
        {
            property: 'isLive',
        ...
        {
            property: 'fullname',
            uri: 'http://scalar.usc.edu/2012/01/scalar-ns#fullname',
            type: 'string'
        },
        {
            property: 'author',
    ...
    this.relationTypes = {
        ...
        'annotation': {
            id: 'annotation',
            body: 'annotation',
            bodyPlural: 'annotations',
            target: 'item',
            targetPlural: 'items',
            incoming: 'annotated by',
            outgoing: 'annotates'
        },
        'comment': {
            id: 'comment',
            ...
            targetPlural: 'items',
            incoming: 'has',
            outgoing: 'is a comment on'
        },
        'commentary': {
            id: 'commentary',
            body: 'commentary',
            bodyPlural: 'commentaries',
            target: 'item',
            targetPlural: 'items',
            incoming: 'has',
            outgoing: 'is a commentary on'
        },
        'review': {
            id: 'review',
            body: 'review',
        ...
        'author': {
            ...
            bodyPlural: 'books',
            target: 'author',
            targetPlural: 'authors',
            incoming: 'written by',
            outgoing: 'has written'
        },
        'commentator': {
            id: 'commentator',
            body: 'book',
            bodyPlural: 'book',
            target: 'commentator',
            targetPlural: 'commentators',
            incoming: 'responded to by',
            outgoing: 'has responded to'
        },
        'reviewer': {
            id: 'reviewer',
            body: 'book',
            bodyPlural: 'books',
            target: 'reviewer',
            targetPlural: 'reviewers',
            incoming: 'reviewed by',
            outgoing: 'has reviewed'
        },
        'unknown': {
            id: 'unknown',
            body: 'item',
